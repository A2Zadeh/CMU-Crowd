"""
Django settings for multicomp_mturk project.
...
SECRET_KEY = '#$h6@76gxj2u!^$+9frwn)zufbug5ethvw8%xwyqc2(#877qmm'
...
WSGI_APPLICATION = 'CMU-Crowd.wsgi.application'
